...
!------------------------------[Local parameters]------------------------------!
  real, parameter :: L1 = 0.699  ! streamwise
  real, parameter :: L2 = 0.699  ! spanwise
  real, parameter :: L3 = 0.699  ! wall-normal
!==============================================================================!
  ...
  !   1st time step   !
  !-------------------!
  if(n .eq. 300010) then     ! should be after the flow is developed
